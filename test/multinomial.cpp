...
TEST(MultinomialTest, LearningAndInference) {
  const char *argv[21] = {"dw",
                          "gibbs",
                          "-w",
                          "./test/multinomial/graph.weights",
                          "-v",
                          "./test/multinomial/graph.variables",
                          "-f",
                          "./test/multinomial/graph.factors",
                          "-m",
                          "./test/multinomial/graph.meta",
                          "-o",
                          "./test/multinomial/",
                          "-l",
                          "2000",
  ...
  std::ifstream fin_weight(
      "./test/multinomial/inference_result.out.weights.text");
  double weight[4];
