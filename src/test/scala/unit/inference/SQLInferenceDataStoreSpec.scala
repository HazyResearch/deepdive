  ...
  describe("Postgres inference data store") {
    ...
    describe("grounding the factor graph with Boolean variables") {
      ...
      it("should work with a one-variable factor rule") {
        ...
        // Ground the graph
        inferenceDataStore.groundFactorGraph(schema, Seq(factorDesc), holdoutFraction, None, false, "")
      ...
      it("should work with multi-variable factor rules") {
        ...
        inferenceDataStore.groundFactorGraph(schema, Seq(factorDesc), 0.0, None, false, "")
    ...
    describe("dumping the factor graph") {
      ...
      it("should work") {
        inferenceDataStore.init()
        inferenceDataStore.groundFactorGraph(Map(), Seq(), 0.0, None, false, "")
