...
i.   _Loading raw input data_
ii.  _Preprocessing input data_
iii. _Extracting candidate relation mentions_
iv.  _Extracting features for each candidate_

### 1.i. Loading Raw Input Data
...
### 1.iii Extracting Candidate Relation Mentions
...
### 1.iv Extracting Features for each Candidate
...
i.   Loading secondary data for distant supervision
ii.  Mapping to our dataset
iii. Other heuristic rules for distant supervision

### 2.i Generating and Loading the Distant Supervision Data
