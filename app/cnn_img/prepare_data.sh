...
export DBNAME=imagenet_images_1p
...
psql $GREENPLUM_FLAGS -d $DBNAME -c "CREATE TABLE variables_layer7(id bigint,\
										image_id bigint,\
										fid int,\
										num_rows int,\
										num_cols int,\
...
psql $GREENPLUM_FLAGS -d $DBNAME -c "CREATE TABLE variables_layer8(id bigint,\
										image_id bigint,\
										fid int,\
										num_rows int,\
										num_cols int,\
...
psql $GREENPLUM_FLAGS -d $DBNAME -c "CREATE TABLE conv_layer0_1(id bigint,\
										...
										center_locations_y int[]) DISTRIBUTED BY (id)"
...
psql $GREENPLUM_FLAGS -d $DBNAME -c "CREATE TABLE conv_layer6_7(id bigint,\
										fid int,\
										location_x int,\
										location_y int,\
										size int,\
...
psql $GREENPLUM_FLAGS -d $DBNAME -c "CREATE TABLE conv_layer7_8(id bigint,\
										fid int,\
										location_x int,\
										location_y int,\
										size int,\
