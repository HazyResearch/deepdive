...
[Knowledge Base Construction](kbc.html). Please refer to other
...
2. Candidate generation and Feature extraction:
  ...
  - Extract all candidate pairs of people that possibly participate in a
    ...
    [distant supervision](relation_extraction.html)
...
You can find more detail from the page about the [structure of a DeepDive app](deepdiveapp.html).
...
supervision](distant_supervision.html) rules that generate
...
[distant supervision](distant_supervision.html). There are some
...
graph](inference.html) to perform probabilistic learning and inference.
...
[factor](inference.html) that is connected to the
