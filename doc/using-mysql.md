...
<todo>Drop this page or rewrite, esp. mysql cluster is not tested well</todo>
...
Extractor types: only tsv_extractor, sql_extractor and cmd_extractor are supported.
...
We integrate this parallel loader into data loading in our extractors.
