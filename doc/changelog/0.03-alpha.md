...
- Supported four new types of extractors. See documentation for details:
  - [tsv_extractor](../extractors.html#tsv_extractor)
  - [plpy_extractor](../extractors.html#plpy_extractor)
  - [sql_extractor](../extractors.html#sql_extractor)
  - [cmd_extractor](../extractors.html#cmd_extractor)
...
- Supported custom holdout by a [holdout query](../calibration.html#custom_holdout).
...
- The `nlp_extractor` example has different table requirements and usage. See here:
  [NLP extractor](../walkthrough-extras.html#nlp_extractor).
