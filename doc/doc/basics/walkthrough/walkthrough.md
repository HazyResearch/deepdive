...
This tutorial describes a common Knowledge Base Construction (KBC) pipeline and
its data flow, and introduce how to implement a KBC application in DeepDive.
...
## <a id="entity_level" href="#"></a> Simple Entity Level Extensions
