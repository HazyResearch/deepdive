...
Extractor types: only [tsv_extractor](extractors.html#tsv_extractor),
[sql_extractor](extractors.html#sql_extractor)
and [cmd_extractor](extractors.html#cmd_extractor) are supported.
...
We integrate this parallel loader into data loading in our [extractors](extractors.html).
