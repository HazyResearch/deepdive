...
[GreenPlum](greenplum) since it gives maximum functionality of
DeepDive. However, DeepDive should also work well with MySQL or MySQL
cluster, other than caveats below.

### Common Caveats

Extractor types: only [tsv_extractor](extractors#tsv_extractor),
[sql_extractor](extractors#sql_extractor)
and [cmd_extractor](extractors#cmd_extractor) are supported.
...
We integrate this parallel loader into data loading in our [extractors](extractors).
