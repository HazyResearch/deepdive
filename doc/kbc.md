...
the ['Probabilistic inference' document](inference) for more details
about this concept).
...
As explained in the [System overview](overview), the steps to
...
relation signals called **evidence**, by running [extractors](extractors)
...
weights](inference) specified in inference rules are calculated.
...
[calibration plot](calibration), and perform **error analysis**
to improve results.
